                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_jurusan" id="nama_jurusan" class="form-control" placeholder="contoh:Teknik Perangkat Lunak" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="alias" id="alias" class="form-control" placeholder="contoh:TPL" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
