...
@section('title', 'Input Ruangan Kuliah')
                        ...
                        <form class="form-horizontal">
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                    <label for="ruangan_kuliah">Nama Ruangan Kuliah</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="ruangan_kuliah" id="ruangan_kuliah" class="form-control" placeholder="Contoh: Ruangan 201" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
