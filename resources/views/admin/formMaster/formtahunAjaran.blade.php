...
@section('title', 'Input Tahun Ajaran')
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="tahun_ajaran" id="tahun_ajaran" class="form-control" placeholder="Tahun Ajaran contoh: 2019/2020" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
